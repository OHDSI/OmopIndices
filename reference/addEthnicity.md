...
The \`x\` table with a new column added with the ethnicity of the
patient.
...
#> Rows: ??
#> Columns: 17
#> Database: DuckDB 1.5.2 [unknown@Linux 6.17.0-1010-azure:R 4.5.3//tmp/Rtmptx4SBk/file1b324a953bdb.duckdb]

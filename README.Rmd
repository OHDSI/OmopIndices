...
The goal of **OmopIndices** is to ... *clearly state the main goal of the package*
...
You can install the development version of OmopIndices from [GitHub](https://github.com/) with:
